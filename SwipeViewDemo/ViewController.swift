...
class ViewController: UIViewController {
    ...
    var people : [Person] = [
        Person(name: "Finn", image: UIImage(named: "bruce.jpg")!),
        Person(name: "Jake", image: UIImage(named: "bruce.jpg")!),
        Person(name: "Fiona", image: UIImage(named: "bruce.jpg")!),
        Person(name: "Prince", image: UIImage(named: "bruce.jpg")!),
        Person(name: "Finn", image: UIImage(named: "bruce.jpg")!),
        Person(name: "Jake", image: UIImage(named: "bruce.jpg")!),
        Person(name: "Fiona", image: UIImage(named: "bruce.jpg")!),
        Person(name: "Prince", image: UIImage(named: "bruce.jpg")!),
